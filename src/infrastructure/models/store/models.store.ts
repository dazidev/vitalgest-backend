...
Delegation.belongsTo(Municipality, {
  foreignKey: "municipality_id",
  as: "municipality",
});
Municipality.hasOne(Delegation, {
  foreignKey: "municipality_id",
  as: "delegation",
});

Pharmacy.belongsTo(Delegation, {
...
// Ambulancias
Ambulance.belongsTo(Delegation, {
  foreignKey: "delegation_id",
  as: "delegation",
});
Delegation.hasMany(Ambulance, {
  foreignKey: "delegation_id",
  as: "ambulances",
});
...
Answer.belongsTo(ChecklistAmbulance, {
  foreignKey: "checklist_ambulance_id",
  as: "checklistAmbulance",
});
ChecklistAmbulance.hasMany(Answer, {
  foreignKey: "checklist_ambulance_id",
  as: "answers",
});
...
SupplyAmbulance.belongsTo(AreaAmbulance, {
  foreignKey: "area_id",
  as: "areaAmbulance",
});
AreaAmbulance.hasMany(SupplyAmbulance, {
  foreignKey: "area_id",
  as: "supplies",
});

SupplyAmbulance.belongsTo(Ambulance, {
  foreignKey: "ambulance_id",
  as: "ambulance",
});
Ambulance.hasMany(SupplyAmbulance, {
  foreignKey: "ambulance_id",
  as: "supplies",
});
