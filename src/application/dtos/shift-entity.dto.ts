...
export class ShiftEntityDto {
  ...
  private static validateData(
    ...
    if (!regularExp.uuid.test(paramedicalId))
      return ERROR_CODES.INVALID_PARAMEDICAL_ID;
  ...
  static create(object: { [key: string]: any }): [string?, ShiftEntityDto?] {
  ...
  static edit(object: { [key: string]: any }): [string?, ShiftEntityDto?] {
  ...
  static delete(object: { [key: string]: any }): [string?, ShiftEntityDto?] {
    const { id } = object;
