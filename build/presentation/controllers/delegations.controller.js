...
class DelegationsController {
    ...
    createDelegation(req, res, next) {
        const [error, delegateEntityDto] = application_1.DelegationEntityDto.create({
            ...req.body,
        });
        if (error)
    ...
    editDelegation(req, res, next) {
        const [error, delegateEntityDto] = application_1.DelegationEntityDto.edit({
            ...req.params,
            ...req.body,
        });
        if (error)
    ...
    deleteDelegation(req, res, next) {
        const [error, delegateEntityDto] = application_1.DelegationEntityDto.delete({
            ...req.params,
            ...req.body,
        });
        if (error)
