...
admRoutes.get('/get-all/users/:amount', [infrastructure_1.AuthMiddleware.validateJWT, infrastructure_1.RankMiddleware.validate('admin', true)], controller.getAllUsers.bind(controller));
