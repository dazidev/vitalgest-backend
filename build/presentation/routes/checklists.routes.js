...
checklistsRoutes.post("/ambulance/create", controller.createAmbChecklist.bind(controller));
checklistsRoutes.put("/ambulance/:id/sign", controller.signAmbChecklist.bind(controller));
...
checklistsRoutes.put("/supply/:id/sign", controller.signSupChecklist.bind(controller));
