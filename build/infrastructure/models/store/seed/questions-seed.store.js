...
exports.createQuestionsSeed = void 0;
const sequelize_adapter_1 = require("../../../config/sequelize.adapter");
const models_store_1 = require("../models.store");
var CATEGORIES;
(function (CATEGORIES) {
    CATEGORIES["C1"] = "Apariencia general";
    CATEGORIES["C2"] = "Compartimiento del operador";
    CATEGORIES["C2_S1"] = "Documentaci\u00F3n";
    CATEGORIES["C2_S2"] = "Aditamientos";
    CATEGORIES["C3"] = "Compartimiento del motor";
    CATEGORIES["C3_S1"] = "Par\u00E1metros de niveles";
    CATEGORIES["C4"] = "Recorrido exterior lado del aperador";
    CATEGORIES["C5"] = "Recorrido exterior frente";
    CATEGORIES["C6"] = "Recorrido exterior lado del copiloto";
    CATEGORIES["C7"] = "Compartimiento del paciente";
...
const createQuestionsSeed = async () => {
    ...
    try {
        ...
        await models_store_1.Question.bulkCreate([
            {
...
exports.createQuestionsSeed = createQuestionsSeed;
